defmodule NervesSystemFairphone2.MixProject do
  use Mix.Project

  @github_organization "Spin42"
  @app :nerves_system_fairphone2
  ...
  defp deps do
    [
      ...
      {:nerves_system_br, git: "https://github.com/mlainez/nerves_system_br.git", branch: "dracut-patch", runtime: false},
